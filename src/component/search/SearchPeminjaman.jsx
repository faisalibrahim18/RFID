...
const SearchPeminjaman = ({ distribusi, setSearchResults }) => {
  ...
  const handleSearchChange = (e) => {
    ...
    const resultsArray = distribusi.filter(
      (item) => item.customer.name.includes(e.target.value) || item.dateIn.includes(e.target.value),
    );
...
export default SearchPeminjaman;
